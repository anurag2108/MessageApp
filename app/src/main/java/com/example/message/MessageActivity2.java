...
import com.example.message.Fragments.APIservice;
import com.example.message.Model.Chat;
import com.example.message.Model.User;
import com.example.message.Notifications.Client;
import com.example.message.Notifications.Data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MessageActivity2.this,MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity2.this,"Empty",Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
